...
<body>
  ...
  <form  method= "POST"class="modal-content" action="/action_page.php">
    <div class="container">
      <center><h1> Doctor Sign Up</h1><p>Please fill in this form to create an account.</p></center> 
  ...
  <label>NMC Lisense Number</label>
  <input type="text" name="lisense_number">
  <br>
  ...
  <br/>
      ...
      <div class="clearfix">
        <input type="button" onclick="location.href='./doctor_verification_link.php';" value="Submit">
      </div>
    </div>
  </form>
</div>
